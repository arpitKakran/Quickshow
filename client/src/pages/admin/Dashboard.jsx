    ...
    <>
      ...
      <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
        ...
        {dashboardData.activeShows.map((show)=>(
            <div key={show._id} className=' bg-primary/10 w-55 rounded-lg overflow-hidden h-full pb-3 border border-primary/20 hover:-translate-y-1 transition duration-300 '>
