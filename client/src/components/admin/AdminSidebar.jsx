...
const AdminSidebar = () => {
  ...
  return (
    <div className=' flex h-[calc(100vh-64px)] md:flex-col items-center pt-8 max-w-13 md:max-w-full border-r border-gray-300/20 text-sm'>
      <img src={user.imageUrl} alt="sidebar" className=" w-16 h-16 rounded-full object-cover" />
